...
const (
	...
	MessageType_MessageType_justchainGetAddress       MessageType = 56
	MessageType_MessageType_justchainAddress          MessageType = 57
	MessageType_MessageType_justchainSignTx           MessageType = 58
	MessageType_MessageType_justchainTxRequest        MessageType = 59
	MessageType_MessageType_justchainTxAck            MessageType = 60
	...
	MessageType_MessageType_justchainSignMessage      MessageType = 64
	MessageType_MessageType_justchainVerifyMessage    MessageType = 65
	MessageType_MessageType_justchainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_justchainGetAddress",
	57:  "MessageType_justchainAddress",
	58:  "MessageType_justchainSignTx",
	59:  "MessageType_justchainTxRequest",
	60:  "MessageType_justchainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_justchainSignMessage",
	65:  "MessageType_justchainVerifyMessage",
	66:  "MessageType_justchainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_justchainGetAddress":       56,
	"MessageType_justchainAddress":          57,
	"MessageType_justchainSignTx":           58,
	"MessageType_justchainTxRequest":        59,
	"MessageType_justchainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_justchainSignMessage":      64,
	"MessageType_justchainVerifyMessage":    65,
	"MessageType_justchainMessageSignature": 66,
...
// *
// Request: Ask device for justchain address corresponding to address_n path
// @next PassphraseRequest
// @next justchainAddress
// @next Failure
type justchainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *justchainGetAddress) Reset()                    { *m = justchainGetAddress{} }
func (m *justchainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*justchainGetAddress) ProtoMessage()               {}
func (*justchainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *justchainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *justchainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an justchain address derived from device private seed
// @prev justchainGetAddress
type justchainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *justchainAddress) Reset()                    { *m = justchainAddress{} }
func (m *justchainAddress) String() string            { return proto.CompactTextString(m) }
func (*justchainAddress) ProtoMessage()               {}
func (*justchainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *justchainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next justchainTxRequest
// @next Failure
type justchainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *justchainSignTx) Reset()                    { *m = justchainSignTx{} }
func (m *justchainSignTx) String() string            { return proto.CompactTextString(m) }
func (*justchainSignTx) ProtoMessage()               {}
func (*justchainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *justchainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *justchainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *justchainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *justchainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *justchainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *justchainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *justchainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *justchainSignTx) GetDataLength() uint32 {
...
func (m *justchainSignTx) GetChainId() uint32 {
...
// @prev justchainSignTx
// @next justchainTxAck
type justchainTxRequest struct {
...
func (m *justchainTxRequest) Reset()                    { *m = justchainTxRequest{} }
func (m *justchainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*justchainTxRequest) ProtoMessage()               {}
func (*justchainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *justchainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *justchainTxRequest) GetSignatureV() uint32 {
...
func (m *justchainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *justchainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev justchainTxRequest
// @next justchainTxRequest
type justchainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *justchainTxAck) Reset()                    { *m = justchainTxAck{} }
func (m *justchainTxAck) String() string            { return proto.CompactTextString(m) }
func (*justchainTxAck) ProtoMessage()               {}
func (*justchainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *justchainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next justchainMessageSignature
// @next Failure
type justchainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *justchainSignMessage) Reset()                    { *m = justchainSignMessage{} }
func (m *justchainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*justchainSignMessage) ProtoMessage()               {}
func (*justchainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *justchainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *justchainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type justchainVerifyMessage struct {
...
func (m *justchainVerifyMessage) Reset()                    { *m = justchainVerifyMessage{} }
func (m *justchainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*justchainVerifyMessage) ProtoMessage()               {}
func (*justchainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *justchainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *justchainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *justchainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev justchainSignMessage
type justchainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *justchainMessageSignature) Reset()                    { *m = justchainMessageSignature{} }
func (m *justchainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*justchainMessageSignature) ProtoMessage()               {}
func (*justchainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *justchainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *justchainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*justchainGetAddress)(nil), "justchainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*justchainAddress)(nil), "justchainAddress")
	...
	proto.RegisterType((*justchainSignTx)(nil), "justchainSignTx")
	proto.RegisterType((*justchainTxRequest)(nil), "justchainTxRequest")
	proto.RegisterType((*justchainTxAck)(nil), "justchainTxAck")
	proto.RegisterType((*justchainSignMessage)(nil), "justchainSignMessage")
	proto.RegisterType((*justchainVerifyMessage)(nil), "justchainVerifyMessage")
	proto.RegisterType((*justchainMessageSignature)(nil), "justchainMessageSignature")
