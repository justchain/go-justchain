## Go justchain Dashboard

The dashboard is a data visualizer integrated into gtst, intended to collect and visualize useful information of an justchain node. It consists of two parts:
