...
// Package types contains data types related to justchain consensus.
package types
...
// Header represents a block header in the justchain blockchain.
type Header struct {
...
// Block represents an entire block in the justchain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the justchain
...
// EncodeRLP serializes b into the justchain RLP block format.
