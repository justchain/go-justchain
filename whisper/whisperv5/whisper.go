...
// Whisper represents a dark communication interface through the justchain
...
// New creates a Whisper client ready to communicate through the justchain P2P network.
