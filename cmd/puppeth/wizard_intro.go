...
// setting up a new or managing an existing justchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to pupptst, your justchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new justchain network down to  |")
	...
	log.Info("Administering justchain network", "name", w.network)
