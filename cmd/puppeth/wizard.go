...
type wizard struct {
	...
	services map[string][]string   // justchain services known to be running on servers
...
// converts it to an justchain address. If an empty line is entered, the default
// value is returned.
