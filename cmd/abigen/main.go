...
import (
	...
	"github.com/justchain/go-justchain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the justchain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the justchain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the justchain contract Solidity source to build and bind")
